...
**All paths in this document are relative to**: `/home/user/dosbox-staging-boxer/`
...
- `/home/user/dosbox-staging-boxer/src/boxer/Boxer/BXEmulator.mm`
- `/home/user/dosbox-staging-boxer/analysis/01-current-integration/...`
...
- **Full Path**: `/home/user/dosbox-staging-boxer/src/dosbox-staging/`
...
#### 2. Boxer Repository
- **Location**: `src/boxer/`
- **Full Path**: `/home/user/dosbox-staging-boxer/src/boxer/`
