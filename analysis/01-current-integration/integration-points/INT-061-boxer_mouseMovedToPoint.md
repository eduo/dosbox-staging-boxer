# boxer_mouseMovedToPoint

**Agent**: Agent 1A - Integration Mapper (stub)
**Created**: 2025-11-14T00:00:00Z
**Status**: Stub - Awaiting Phase 1B analysis
**Dependencies**: None
**Integration ID**: INT-061

## Summary
Minor integration point. Mouse position tracking - updates mouse position

## Current Implementation (Legacy DOSBox)

**Boxer Location**: BXEmulator.mm
**DOSBox Location**: Called from Boxer input handling
**Type**: API Function
**Criticality**: Minor
**Coupling**: Medium

## Purpose
Mouse position tracking - updates mouse position
