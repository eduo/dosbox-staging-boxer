...
## Summary
Core integration point. Frame buffer setup - provides raw frame buffer to DOSBox

## Current Implementation (Legacy DOSBox)

**Boxer Location**: BXCoalface.h:27, BXCoalface.mm
**DOSBox Location**: Multiple files (GFX_StartUpdate macro)
**Type**: Macro Replacement
**Criticality**: Core
**Coupling**: Tight

## Purpose
Frame buffer setup - provides raw frame buffer to DOSBox
