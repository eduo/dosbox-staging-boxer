# boxer_shouldShowFileWithName

**Agent**: Agent 1A - Integration Mapper (stub)
**Created**: 2025-11-14T00:00:00Z
**Status**: Stub - Awaiting Phase 1B analysis
**Dependencies**: None
**Integration ID**: INT-040

## Summary
Major integration point. File visibility filtering - hides macOS metadata files

## Current Implementation (Legacy DOSBox)

**Boxer Location**: BXEmulator+BXDOSFileSystem.mm
**DOSBox Location**: dos/drive_cache.cpp:804
**Type**: Decision Callback
**Criticality**: Major
**Coupling**: Medium

## Purpose
File visibility filtering - hides macOS metadata files
