...
**IMPORTANT**: All paths are relative to `/home/user/dosbox-staging-boxer/`

This is the working directory root. When instructions say "modify src/dosbox-staging/...", the full path is:
`/home/user/dosbox-staging-boxer/src/dosbox-staging/...`
...
**Critical** Read:
/home/user/dosbox-staging-boxer/instructions/CLAUDE_REFERENCE.md 
...
- Changes to dosbox-staging-boxer structure: commit from main repo root
