...
**Dependencies**: None
**Integration ID**: INT-074

## Summary
Minor integration point. Key injection - provides next buffered keycode

## Current Implementation (Legacy DOSBox)

**Boxer Location**: BXCoalface.mm
**DOSBox Location**: ints/bios_keyboard.cpp:162,188
**Type**: Callback Function
**Criticality**: Minor
**Coupling**: Medium

## Purpose
Key injection - provides next buffered keycode
