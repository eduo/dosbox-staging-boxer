...
git format-patch origin/dosbox-boxer-upgrade-dosboxside..HEAD --stdout > \
  /home/user/dosbox-staging-boxer/phase-X-dosbox-changes.patch

# Verify patch was created
ls -lh /home/user/dosbox-staging-boxer/phase-X-dosbox-changes.patch
```
...
git format-patch origin/boxer-dosbox-upgrade-boxerside..HEAD --stdout > \
  /home/user/dosbox-staging-boxer/phase-X-boxer-changes.patch

# Verify patch was created
ls -lh /home/user/dosbox-staging-boxer/phase-X-boxer-changes.patch
```
...
2. Download the patch:
   ```bash
   curl -O https://raw.githubusercontent.com/eduo/dosbox-staging-boxer/claude/phase-1-orchestrator-01H1B4jhqBRczSnhhSghWmN6/phase-X-dosbox-changes.patch
   ```
...
2. Download the patch:
   ```bash
   curl -O https://raw.githubusercontent.com/eduo/dosbox-staging-boxer/claude/phase-1-orchestrator-01H1B4jhqBRczSnhhSghWmN6/phase-X-boxer-changes.patch
   ```
