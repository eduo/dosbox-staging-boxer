# boxer_setCGACompositeHueOffset
...
## Summary
Minor integration point. CGA graphics mode - sets hue offset

## Current Implementation (Legacy DOSBox)

**Boxer Location**: vga_other.cpp:1477
**DOSBox Location**: vga_other.cpp:1477
**Type**: Accessor Function
**Criticality**: Minor
**Coupling**: Loose

## Purpose
CGA graphics mode - sets hue offset
