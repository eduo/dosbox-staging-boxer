...
**Dependencies**: None
**Integration ID**: INT-064

## Summary
Minor integration point. Keyboard layout - returns current layout name

## Current Implementation (Legacy DOSBox)

**Boxer Location**: BXCoalface.mm
**DOSBox Location**: dos/dos_keyboard_layout.cpp:1145
**Type**: Query Function
**Criticality**: Minor
**Coupling**: Medium

## Purpose
Keyboard layout - returns current layout name
