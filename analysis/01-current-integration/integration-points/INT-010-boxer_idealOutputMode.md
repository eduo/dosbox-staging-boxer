...
## Summary
Core integration point. Output mode selection - determines rendering mode

## Current Implementation (Legacy DOSBox)

**Boxer Location**: BXCoalface.h:35, BXCoalface.mm
**DOSBox Location**: Multiple files (GFX_GetBestMode macro)
**Type**: Macro Replacement
**Criticality**: Core
**Coupling**: Tight

## Purpose
Output mode selection - determines rendering mode
