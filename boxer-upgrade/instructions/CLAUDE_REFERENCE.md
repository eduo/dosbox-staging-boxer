...
└── boxer-upgrade/                    ← Main repo (dosbox-staging-boxer)
...
**IMPORTANT**: All paths in this project are relative to `/home/user/dosbox-staging-boxer/boxer-upgrade/`
...
```
Read: /home/user/dosbox-staging-boxer/boxer-upgrade/src/dosbox-staging/CMakeLists.txt
Read: /home/user/dosbox-staging-boxer/boxer-upgrade/src/boxer/BXEmulator.mm
```
...
```
Edit: /home/user/dosbox-staging-boxer/boxer-upgrade/src/dosbox-staging/include/boxer/boxer_hooks.h
Write: /home/user/dosbox-staging-boxer/boxer-upgrade/validation/smoke-test/test.cpp
```
...
```bash
Glob: pattern="**/boxer_hooks.h" path="/home/user/dosbox-staging-boxer/boxer-upgrade/src/dosbox-staging"
Grep: pattern="IBoxerDelegate" path="/home/user/dosbox-staging-boxer/boxer-upgrade/src"
```
...
2. **DOSBox Staging Repo**:
   - Path: `/home/user/dosbox-staging-boxer/boxer-upgrade/src/dosbox-staging/`
   - Branch: `dosbox-boxer-upgrade-dosboxside`
   - Purpose: DOSBox modifications (hooks, build system)

3. **Boxer Repo**:
   - Path: `/home/user/dosbox-staging-boxer/boxer-upgrade/src/boxer/`
...
git status
git add boxer-upgrade/progress/phase-1/OBJECTIVES.md
...
# DOSBox Staging
cd /home/user/dosbox-staging-boxer/boxer-upgrade/src/dosbox-staging && git status

# Boxer
cd /home/user/dosbox-staging-boxer/boxer-upgrade/src/boxer && git status
```
...
```bash
Bash: cd /home/user/dosbox-staging-boxer/boxer-upgrade/src/dosbox-staging && git status
```
...
```
Read: /home/user/dosbox-staging-boxer/boxer-upgrade/instructions/MASTER_ORCHESTRATOR.md
```

**Check current phase:**
```
Read: /home/user/dosbox-staging-boxer/boxer-upgrade/PROGRESS.md
```

**View phase objectives:**
```
Read: /home/user/dosbox-staging-boxer/boxer-upgrade/progress/phase-1/OBJECTIVES.md
```

**Create patch files:**
```
See: /home/user/dosbox-staging-boxer/boxer-upgrade/instructions/PHASE_COMPLETION_TEMPLATE.md
```
