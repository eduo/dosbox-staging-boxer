...
## Summary
Major integration point. Palette color management - handles color conversion

## Current Implementation (Legacy DOSBox)

**Boxer Location**: BXCoalface.h:33, BXCoalface.mm
**DOSBox Location**: Multiple files (GFX_GetRGB macro)
**Type**: Macro Replacement
**Criticality**: Major
**Coupling**: Tight

## Purpose
Palette color management - handles color conversion
