...
- **Location**: `/home/user/dosbox-staging-boxer/boxer-upgrade/src/dosbox-staging/`
...
1. ✅ Cloned repository to `/home/user/dosbox-staging-boxer/boxer-upgrade/src/dosbox-staging/`
...
```bash
cd boxer-upgrade/src/dosbox-staging
