...
### 1. boxer_types.h
**Location**: `/home/user/dosbox-staging-boxer/boxer-upgrade/src/dosbox-staging/include/boxer/boxer_types.h`
...
### 2. boxer_hooks.h
**Location**: `/home/user/dosbox-staging-boxer/boxer-upgrade/src/dosbox-staging/include/boxer/boxer_hooks.h`
...
1. `/home/user/dosbox-staging-boxer/boxer-upgrade/src/dosbox-staging/include/boxer/boxer_types.h`
   - 92 lines
   - Type definitions and forward declarations

2. `/home/user/dosbox-staging-boxer/boxer-upgrade/src/dosbox-staging/include/boxer/boxer_hooks.h`
   - 1064 lines
   - Complete IBoxerDelegate interface
   - 83 method declarations
   - 5 hook invocation macros

3. `/home/user/dosbox-staging-boxer/boxer-upgrade/progress/phase-1/tasks/TASK-1-2.md`
