...
## Summary
Major integration point. Mouse input mode - controls mouse capture/release

## Current Implementation (Legacy DOSBox)

**Boxer Location**: BXCoalface.h:29, BXCoalface.mm
**DOSBox Location**: Multiple files (Mouse_AutoLock macro)
**Type**: Macro Replacement
**Criticality**: Major
**Coupling**: Tight

## Purpose
Mouse input mode - controls mouse capture/release
